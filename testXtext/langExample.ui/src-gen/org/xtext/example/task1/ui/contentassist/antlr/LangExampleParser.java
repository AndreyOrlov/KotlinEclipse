...
* generated by Xtext
*/
package org.xtext.example.task1.ui.contentassist.antlr;
...
public class LangExampleParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.example.task1.ui.contentassist.antlr.internal.InternalLangExampleParser createParser() {
		org.xtext.example.task1.ui.contentassist.antlr.internal.InternalLangExampleParser result = new org.xtext.example.task1.ui.contentassist.antlr.internal.InternalLangExampleParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSeqStatementAccess().getAlternatives(), "rule__SeqStatement__Alternatives");
					...
					put(grammarAccess.getFunctionAccess().getGroup_5_0(), "rule__Function__Group_5_0__0");
					...
					put(grammarAccess.getSeqStatementAccess().getGroup_0(), "rule__SeqStatement__Group_0__0");
					put(grammarAccess.getSeqStatementAccess().getGroup_1(), "rule__SeqStatement__Group_1__0");
					put(grammarAccess.getSeqStatementAccess().getGroup_1_1(), "rule__SeqStatement__Group_1_1__0");
					...
					put(grammarAccess.getBinExpressionAccess().getGroup(), "rule__BinExpression__Group__0");
					...
					put(grammarAccess.getFunctionAccess().getDefAssignment_3_0(), "rule__Function__DefAssignment_3_0");
					put(grammarAccess.getFunctionAccess().getDef2Assignment_3_1_1(), "rule__Function__Def2Assignment_3_1_1");
					put(grammarAccess.getFunctionAccess().getStmtsAssignment_5_1_1(), "rule__Function__StmtsAssignment_5_1_1");
					put(grammarAccess.getVarDefAccess().getNameAssignment_0(), "rule__VarDef__NameAssignment_0");
					put(grammarAccess.getVarDefAccess().getTypeAssignment_2(), "rule__VarDef__TypeAssignment_2");
					...
					put(grammarAccess.getClassAccess().getElementsAssignment_2_1(), "rule__Class__ElementsAssignment_2_1");
					put(grammarAccess.getTraitAccess().getNameAssignment_1(), "rule__Trait__NameAssignment_1");
					put(grammarAccess.getTraitAccess().getClassAssignment_3(), "rule__Trait__ClassAssignment_3");
					put(grammarAccess.getTraitAccess().getValidIdAssignment_5(), "rule__Trait__ValidIdAssignment_5");
					put(grammarAccess.getSeqStatementAccess().getStmtAssignment_0_0(), "rule__SeqStatement__StmtAssignment_0_0");
					put(grammarAccess.getSeqStatementAccess().getStmtsAssignment_1_1_0(), "rule__SeqStatement__StmtsAssignment_1_1_0");
					put(grammarAccess.getAssignAccess().getVarAssignment_0(), "rule__Assign__VarAssignment_0");
					put(grammarAccess.getAssignAccess().getExprAssignment_2(), "rule__Assign__ExprAssignment_2");
					put(grammarAccess.getIfAccess().getExprAssignment_2(), "rule__If__ExprAssignment_2");
					put(grammarAccess.getIfAccess().getStmt1Assignment_4(), "rule__If__Stmt1Assignment_4");
					put(grammarAccess.getIfAccess().getStmt2Assignment_6(), "rule__If__Stmt2Assignment_6");
					...
					put(grammarAccess.getBinExpressionAccess().getExpr1Assignment_0(), "rule__BinExpression__Expr1Assignment_0");
					put(grammarAccess.getBinExpressionAccess().getExprAssignment_2(), "rule__BinExpression__ExprAssignment_2");
					put(grammarAccess.getSimpleExpressionAccess().getVarAssignment_1(), "rule__SimpleExpression__VarAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.example.task1.ui.contentassist.antlr.internal.InternalLangExampleParser typedParser = (org.xtext.example.task1.ui.contentassist.antlr.internal.InternalLangExampleParser) parser;
